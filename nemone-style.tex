...
\vspace{0.1cm}
\scriptsize
 جلد 1 شماره 1 (1392)، صص. 1-4\\
\scriptsize
\copyright{} 1392 دانشگاه اصفهان \\ \bottomrule
\end{tabular}
\hfill
\begin{tabular}{c}
...
\setiranicfont[Scale=1.1]{XB Niloofar}
...
\newcommand{\emaillink}[1]{\href{mailto:#1}{\lr{\ttfamily#1}}}
\makeatother
